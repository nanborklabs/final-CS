...
import nanborklabs.csstack.Points.Daapoints;
import nanborklabs.csstack.R;

/**
 * Created by nandhu on 8/7/16.
 */
public class DaaFrag extends android.support.v4.app.Fragment {
    public View mView;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mViewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                switch (position){
                    case 0:
                        sub.setText("Divide and Conquer");
                        break;
                    case 1:sub.setText("Greedy and Dynamic Algorithms");
                        break;
                    case 2:sub.setText("Backtracking & Branch-and-Bround");
                        break;
                    case 3:sub.setText("Parallel Algorithms");
                        break;
                    case 4:sub.setText("NP Problem");
                        break;
                }
            }
    ...
    public class ViewPagerAdapter extends FragmentPagerAdapter {
        ...
        public Daapoints showpointsFragment;
        ...
        public ViewPagerAdapter(FragmentManager fm) {
            ...
            if (showpointsFragment==null){
                showpointsFragment=new Daapoints();
            }
            else {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position){
                case 0:
                    return  Daapoints.newInstance(position);
