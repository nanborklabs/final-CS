...
import nanborklabs.csstack.Points.PPpoints;
import nanborklabs.csstack.R;

/**
 * Created by nandhu on 8/7/16.
 */
public class PPFrag extends android.support.v4.app.Fragment {
    public View mView;
            ...
            public void onPageSelected(int position) {
                switch (position){
                    case 0:
                        ...
                        break;
                    case 1:sub.setText("Semantics");
                        break;
                    case 2:sub.setText("Functions");
                        break;
                    case 3:sub.setText("Programming Techniques");
                        break;
                    case 4:sub.setText("Modern Techniques");
                        break;
                }
            }
    ...
    public class ViewPagerAdapter extends FragmentPagerAdapter {
        ...
        public PPpoints showpointsFragment;
        ...
        public ViewPagerAdapter(FragmentManager fm) {
            ...
            if (showpointsFragment==null){
                showpointsFragment=new PPpoints();
            }
            else {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position){
                case 0:
                    return  PPpoints.newInstance(position);
