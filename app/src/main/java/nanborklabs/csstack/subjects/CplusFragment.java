...
import nanborklabs.csstack.Points.cpluspoints;
import nanborklabs.csstack.R;

/**
 * Created by nandhu on 8/7/16.
 */
public class CplusFragment extends android.support.v4.app.Fragment {
    public View mView;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mViewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                switch (position){
                    case 0:
                        sub.setText("Pointer and File handling");
                        break;
                    case 1:sub.setText("Introduction to OOPS");
                        break;
                    case 2:sub.setText("OOPS Concepts");
                        break;
                    case 3:sub.setText("Templates and Exception Handling");
                        break;
                    case 4:sub.setText("Advance Features");
                        break;
                }
            }
    ...
    public class ViewPagerAdapter extends FragmentPagerAdapter {
        ...
        public cpluspoints showpointsFragment;
        ...
        public ViewPagerAdapter(FragmentManager fm) {
            ...
            if (showpointsFragment==null){
                showpointsFragment=new cpluspoints();
            }
            else {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position){
                case 0:
                    return  cpluspoints.newInstance(position);
