...
import nanborklabs.csstack.Points.Dbmspoints;
import nanborklabs.csstack.R;

/**
 * Created by nandhu on 8/7/16.
 */
public class DbmsFrag extends android.support.v4.app.Fragment {
    public View mView;
            ...
            public void onPageSelected(int position) {
                switch (position){
                    case 0:
                        ...
                        break;
                    case 1:sub.setText("ER & Relational Models");
                        break;
                    case 2:sub.setText("Data Definition & Querying");
                        break;
                    case 3:sub.setText("Transaction & Concurrency");
                        break;
                    case 4:sub.setText("Advanced Topics");
                        break;
                }
            }
    ...
    public class ViewPagerAdapter extends FragmentPagerAdapter {
        ...
        public Dbmspoints showpointsFragment;
        ...
        public ViewPagerAdapter(FragmentManager fm) {
            ...
            if (showpointsFragment==null){
                showpointsFragment=new Dbmspoints();
            }
            else {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position){
                case 0:
                    return  Dbmspoints.newInstance(position);
