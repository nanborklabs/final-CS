...
import nanborklabs.csstack.Points.Ooadpoints;
import nanborklabs.csstack.R;

/**
 * Created by nandhu on 8/7/16.
 */
public class OoadFrag extends android.support.v4.app.Fragment {
    public View mView;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mViewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                switch (position){
                    case 0:
                        sub.setText("Basics Of OOAD");
                        break;
                    case 1:sub.setText("Requirement and Moore Modelling");
                        break;
                    case 2:sub.setText("Design Principles");
                        break;
                    case 3:sub.setText("Designing to Code");
                        break;
                    case 4:sub.setText("Further Patterns");
                        break;
                }
            }
    ...
    public class ViewPagerAdapter extends FragmentPagerAdapter {
        ...
        public Ooadpoints showpointsFragment;
        ...
        public ViewPagerAdapter(FragmentManager fm) {
            ...
            if (showpointsFragment==null){
                showpointsFragment=new Ooadpoints();
            }
            else {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position){
                case 0:
                    return  Ooadpoints.newInstance(position);
