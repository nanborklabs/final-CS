 ...
 */
public class CGFrag extends android.support.v4.app.Fragment {
    public View mView;
    ...
    public class ViewPagerAdapter extends FragmentPagerAdapter {
        ...
        public CGpoints showpointsFragment;
        ...
        public ViewPagerAdapter(FragmentManager fm) {
            ...
            if (showpointsFragment==null){
                showpointsFragment=new CGpoints();
            }
            else {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position){
                case 0:
                    return  CGpoints.newInstance(position);
