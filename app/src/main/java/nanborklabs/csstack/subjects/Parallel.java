...
import nanborklabs.csstack.Points.Parallelpoints;
import nanborklabs.csstack.R;

/**
 * Created by nandhu on 8/7/16.
 */
public class Parallel extends android.support.v4.app.Fragment {
    public View mView;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        title.setText(R.string.parallel);
        ...
        mViewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                switch (position){
                    case 0:
                        sub.setText("Fundamentals");
                        break;
                    case 1:sub.setText("Challenges in Parallel Computing");
                        break;
                    case 2:sub.setText("OpenMP and Shared Memory models");
                        break;
                    case 3:sub.setText("MPI programming");
                        break;
                    case 4:sub.setText("Heterogeneous Processors");
                        break;
                }
            }
    ...
    public class ViewPagerAdapter extends FragmentPagerAdapter {
        ...
        public Parallelpoints showpointsFragment;
        ...
        public ViewPagerAdapter(FragmentManager fm) {
            ...
            if (showpointsFragment==null){
                showpointsFragment=new Parallelpoints();
            }
            else {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position){
                case 0:
                    return  Parallelpoints.newInstance(position);
