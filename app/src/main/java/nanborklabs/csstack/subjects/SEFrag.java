...
import nanborklabs.csstack.Points.SEpoints;
import nanborklabs.csstack.R;

/**
 * Created by nandhu on 8/7/16.
 */
public class SEFrag extends android.support.v4.app.Fragment {
    public View mView;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mViewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                switch (position){
                    case 0:
                        sub.setText("Software Process Models");
                        break;
                    case 1:sub.setText("Requirement Engineering");
                        break;
                    case 2:sub.setText("Analysis Modelling");
                        break;
                    case 3:sub.setText("Design and Testing");
                        break;
                    case 4:sub.setText("Quality and Maintenance");
                        break;
                }
            }
    ...
    public class ViewPagerAdapter extends FragmentPagerAdapter {
        ...
        public SEpoints showpointsFragment;
        ...
        public ViewPagerAdapter(FragmentManager fm) {
            ...
            if (showpointsFragment==null){
                showpointsFragment=new SEpoints();
            }
            else {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position){
                case 0:
                    return  SEpoints.newInstance(position);
