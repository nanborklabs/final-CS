...
import nanborklabs.csstack.Points.computerArchpoints;
import nanborklabs.csstack.R;

/**
 * Created by nandhu on 8/7/16.
 */
public class ComputerarchFragment extends android.support.v4.app.Fragment {
    public View mView;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mViewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                switch (position){
                    case 0:
                        sub.setText("Fundamentals Of Computer Systems");
                        break;
                    case 1:sub.setText("Basic Processing Unit");
                        break;
                    case 2:sub.setText("ILP");
                        break;
                    case 3:sub.setText("Computer Arithmetic");
                        break;
                    case 4:sub.setText("Memory and I/O");
                        break;
                }
            }
    ...
    public class ViewPagerAdapter extends FragmentPagerAdapter {
        ...
        public computerArchpoints showpointsFragment;
        ...
        public ViewPagerAdapter(FragmentManager fm) {
            ...
            if (showpointsFragment==null){
                showpointsFragment=new computerArchpoints();
            }
            else {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position){
                case 0:
                    return  computerArchpoints.newInstance(position);
