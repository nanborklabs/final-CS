...
import nanborklabs.csstack.Points.SSpoints;
 ...
 */
public class SSFrag extends android.support.v4.app.Fragment {
    public View mView;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        mViewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                switch (position){
                    case 0:
                        sub.setText("Assemblers Overview");
                        break;
                    case 1:sub.setText("Loaders and Linkers");
                        break;
                    case 2:sub.setText("Macroprocessor");
                        break;
                    case 3:sub.setText("Virtual Machine");
                        break;
                    case 4:sub.setText("Advanced Feature");
                        break;
                }
            }
    ...
    public class ViewPagerAdapter extends FragmentPagerAdapter {
        ...
        public SSpoints showpointsFragment;
        ...
        public ViewPagerAdapter(FragmentManager fm) {
            ...
            if (showpointsFragment==null){
                showpointsFragment=new SSpoints();
            }
            else {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position){
                case 0:
                    return  SSpoints.newInstance(position);
