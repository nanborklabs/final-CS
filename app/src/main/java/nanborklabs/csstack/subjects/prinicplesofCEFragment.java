...
import nanborklabs.csstack.Points.Principlespoints;
import nanborklabs.csstack.R;

/**
 * Created by nandhu on 8/7/16.
 */
public class prinicplesofCEFragment extends android.support.v4.app.Fragment {
    public View mView;
            ...
            public void onPageSelected(int position) {
                switch (position){
                    case 0:
                        ...
                        break;
                    case 1:sub.setText("Software and Hardware");
                        break;
                    case 2:sub.setText("Operating Systems");
                        break;
                    case 3:sub.setText("Database Management");
                        break;
                    case 4:sub.setText("Networks");
                        break;
                }
            }
    ...
    public class ViewPagerAdapter extends FragmentPagerAdapter {
        ...
        public Principlespoints showpointsFragment;
        ...
        public ViewPagerAdapter(FragmentManager fm) {
            ...
            if (showpointsFragment==null){
                showpointsFragment=new Principlespoints();
            }
            else {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position){
                case 0:
                    return  Principlespoints.newInstance(position);
